...
export default function HomeScreen() {
    ...
    return (
        <View style={{ alignItems: 'center', paddingTop: 90 }}>
            ...
            <TouchableOpacity 
                style={[{ backgroundColor: selectedChatFace.primary }, { marginTop: 40, padding: 17, width: Dimensions.get('screen').width * 0.6, borderRadius: 100, alignItems: 'center' }]} 
                onPress={() => router.push('./ChatScreen')} // Use router.push to navigate
            >
